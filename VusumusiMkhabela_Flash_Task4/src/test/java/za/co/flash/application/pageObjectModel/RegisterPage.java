...
public class RegisterPage {
	...
	public void registerUser(String fName, String lName, String emailAdd, String pass) {
		...
		System.out.println("####Test Case 01 done by V.Mkhabela#####");
		System.out.println("\n\n--------------------Test Steps------------------------");
		...
		System.out.println("1.4. The user enters first name into the first name field.");
		
		lNameEl(driver).sendKeys(lName);
		System.out.println("1.5. The user enters last name into the last name field.");
		
		emailAddEl(driver).sendKeys(emailAdd);
		System.out.println("1.6. The user enters email into the email field.");
		...
		System.out.println("1.10 The user clicks the Register button.");
	}
}
